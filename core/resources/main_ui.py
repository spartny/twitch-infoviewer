...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.textEdit, 2, 3, 1, 3)
        ...
        QWidget.setTabOrder(self.lineEdit_twitchUsername, self.pushButton_FetchAPI)
        QWidget.setTabOrder(self.pushButton_FetchAPI, self.listWidget)
        ...
        QWidget.setTabOrder(self.pushButton_ExportFiles, self.pushButton_ExportFile)
